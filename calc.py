...
entNumber1 = Entry(root, width = 12, justify = RIGHT)
entNumber1.grid(row = 0, column = 2, columnspan = 2, sticky = W)

lblNumber2 = Label(root, text="Число 2", width = 10, anchor = W)
lblNumber2.grid(row = 1, column = 0, columnspan = 2, sticky = W)
entNumber2 = Entry(root, width = 12, justify = RIGHT)
entNumber2.grid(row = 1, column = 2, columnspan = 2, sticky = W)

lblResult = Label(root, text="Результат", width = 10, anchor = W)
lblResult.grid(row = 2, column = 0, columnspan = 2, sticky = W)
entResult = Entry(root, width = 12, justify = RIGHT)
entResult.grid(row = 2, column = 2, columnspan = 2, sticky = W)
...
for i in range(4):
    for j in range(4):
        ...
        btn.grid(row = i+3, column = j,padx=2,pady=2)
root.mainloop()
>>>>>>> a7b7cafc19a3b54d8efa763a8d27c262c00b7f24
